...
alias check-network="nmap -sn"
alias neofetch="while :; do neofetch; sleep 600; done"
alias spelltable="firefox https://spelltable.wizards.com/"
alias mtgo="~/Programs/run-mtgo"
